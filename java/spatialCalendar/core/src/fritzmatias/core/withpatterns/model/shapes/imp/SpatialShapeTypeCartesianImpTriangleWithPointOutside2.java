 ...
 */
public final class SpatialShapeTypeCartesianImpTriangleWithPointOutside2 extends SpatialShapeType {

	public SpatialShapeTypeCartesianImpTriangleWithPointOutside2() {
		super("normal");
	}
	...
	public boolean test(SpatialShapeContext context) {
		...
		if (helper.isTriangle()) {
			if (!helper.isInternalPoint()) {
				...
				if (helper.isTheEvaluationPointAlignedWithASide()) {
