 ...
 * @since Version: 2
 */
public final class SpatialShapeTypeCartesianImpLineWithPointOutside2 extends SpatialShapeType {

	public SpatialShapeTypeCartesianImpLineWithPointOutside2() {
		super("optimo");
	...
	public boolean test(SpatialShapeContext context) {
		...
		return !helper.isTheEvaluationPointAlignedWithASide()
				&& helper.isALine();
	}
