 ...
 * @since Version: 2
 */
public final class SpatialShapeTypeCartesianImpLineWithPointInside extends SpatialShapeType {

	public SpatialShapeTypeCartesianImpLineWithPointInside() {
		super("sequia");
	}
	...
	public boolean test(SpatialShapeContext context) {
		...
		return MathAccuracy.equals(a.crossProduct(b, c), 0, context.getScale())
				&& MathAccuracy.equals(p.crossProduct(a, b), 0, context.getScale());
	}
